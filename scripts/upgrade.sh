...
sleep 30;
/usr/bin/php /var/www/html/admin/cli/install.php --wwwroot=http://${elb_endpoint}/ --dataroot=/var/moodledata --dbtype=mysqli --dbhost=${databases_ip} --dbport=3306 --dbname=${db_name} --dbuser=${db_user_name} --dbpass=${db_pass} --fullname="Moodle" --adminpass=1Qaz2wsx$ --adminemail=malyna.mykola95@gmail.com --shortname="Moodle" --non-interactive --agree-license
